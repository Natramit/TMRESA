    ...
    for(;;){
        ...
        */
        ...
        for(;;){
            ...
            loop_V--;
            if(loop_V<0)loop_V=base_V;
            //console.log('get ',get_V,loop_V);
            if(Remainder_Form_Base10[get_V][loop_V]){
                temp1=false;
                if(Remainder_Form_Base10[get_V][loop_V]===true){
                    A_R[number0]=number1;
                }
                else if(Remainder_Form_Base10[get_V][loop_V]==base_V){
                    A_R[number0]=0;
                }
                else{
                    A_R[number0]=Remainder_Form_Base10[get_V][loop_V];
                }
